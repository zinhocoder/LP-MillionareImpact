...
export default function Home() {
  ...
  const [typebotCompleted, setTypebotCompleted] = useState(false)
  ...
  // Função para rastrear eventos de compra com o Pixel do Facebook
  const trackPurchase = (value: string, currency = "BRL") => {
  ...
  // Função para rastrear eventos de lead com o Pixel do Facebook
  const trackLead = () => {
    if (typeof window !== "undefined" && (window as any).fbq) {
  ...
  // Quando o Typebot é completado
  const handleTypebotComplete = () => {
    setTypebotCompleted(true)
  ...
  return (
    <div className="min-h-screen bg-black text-white">
          ...
          <div className="md:flex items-center">
            <div className="md:w-1/2 z-10 relative">
              ...
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 leading-tight">
                Descubra como alavancar o faturamento da sua empresa em até 30 dias com{" "}
                <span className="text-amber-500">estratégia e execução real!</span>
              </h1>
              ...
              <p className="text-gray-300 mb-8 text-lg">
                Mentoria comercial para empresários B2B que querem sair do esforço invisível e transformar equipe,
                oferta e operação em lucro previsível, mês após mês.
              </p>
              ...
              <div className="mb-8 space-y-3">
                <div className="flex items-start">
                  ...
                  <p className="text-gray-100 text-lg">
                    <strong className="text-amber-500">Pilar 1 –</strong> Venda Direta
                  </p>
                </div>
                <div className="flex items-start">
                  <span className="mr-2 mt-1 w-2 h-2 rounded-full bg-amber-500"></span>
                  <p className="text-gray-100 text-lg">
                    <strong className="text-amber-500">Pilar 2 –</strong> Pessoas e Performance
                  </p>
                </div>
                <div className="flex items-start">
                  <span className="mr-2 mt-1 w-2 h-2 rounded-full bg-amber-500"></span>
                  <p className="text-gray-100 text-lg">
                    <strong className="text-amber-500">Pilar 3 –</strong> Estrutura
                  </p>
                </div>
              </div>
              ...
              <div className="relative h-[380px] sm:h-[420px]">
                ...
                <div className="absolute bottom-0 left-0 p-5 sm:p-6 z-20 w-full text-center text-white space-y-3">
                  ...
                  <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                    Já faturam, têm operação, mas sentem que estão longe do potencial máximo. Falta clareza sobre o que
                    ajustar para escalar com lucro.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-b from-zinc-900 to-black rounded-xl overflow-hidden shadow-xl border border-zinc-800 group hover:border-amber-500/30 transition-all duration-300">
              <div className="relative h-[380px] sm:h-[420px]">
                ...
                <div className="absolute bottom-0 left-0 p-5 sm:p-6 z-20 w-full text-center text-white space-y-3">
                  ...
                  <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                    Cansaram de operar no modo reativo. Buscam organizar processos, time e estratégia para trabalhar
                    menos e lucrar mais com previsibilidade.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-b from-zinc-900 to-black rounded-xl overflow-hidden shadow-xl border border-zinc-800 group hover:border-amber-500/30 transition-all duration-300">
              <div className="relative h-[380px] sm:h-[420px]">
                ...
                <div className="absolute bottom-0 left-0 p-5 sm:p-6 z-20 w-full text-center text-white space-y-3">
                  ...
                  <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                    Lideram equipes que não performam como deveriam. Precisam destravar o engajamento do time e alinhar
                    todos com metas claras e executáveis.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-zinc-950 relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-zinc-900 to-black rounded-xl overflow-hidden shadow-xl border border-zinc-800 group hover:border-amber-500/30 transition-all duration-300">
              <div className="relative">
                <video src="/videos/" className="w-full h-full object-contain" controls preload="metadata"></video>
                <div className="absolute bottom-0 left-0 right-0 p-6 z-30 bg-gradient-to-t from-black/80 to-transparent">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-black text-xl max-w-3xl mx-auto font-medium mb-4">
              Em uma sessão individual de 1 hora, você terá acesso direto à minha experiência prática, onde vamos
              alinhar os pilares do seu negócio para gerar lucro real, estrutura sólida e{" "}
              <strong>ações de alta performance.</strong>
            </p>

            <p className="text-black text-xl max-w-3xl mx-auto font-medium">
              Essa sessão é o primeiro passo para empresários que querem sair do modo operacional. É hora de assumir o
              comando de um <strong>negócio lucrativo e escalável.</strong>
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            ...
            <div className="bg-black/10 backdrop-blur-sm p-8 rounded-xl shadow-xl border border-white/20 hover:border-white/40 transition-all duration-300 relative z-10">
              ...
              <p className="text-black text-lg">
                Analisamos com profundidade onde estão os gargalos, travas e lucros ocultos da sua operação. É aqui que
                você descobre por que está deixando dinheiro na mesa e o que precisa mudar agora.
              </p>
            </div>
            ...
            <div className="bg-black/10 backdrop-blur-sm p-8 rounded-xl shadow-xl border border-white/20 hover:border-white/40 transition-all duration-300 relative z-10 mt-16">
              ...
              <p className="text-black text-lg">
                Revisamos suas metas com foco em clareza, escalabilidade e resultado. Nada de objetivos soltos: você sai
                com indicadores alinhados à realidade e ao potencial do seu negócio.
              </p>
            </div>
            ...
            <div className="bg-black/10 backdrop-blur-sm p-8 rounded-xl shadow-xl border border-white/20 hover:border-white/40 transition-all duration-300 relative z-10 mt-16 md:mt-0">
              ...
              <p className="text-black text-lg">
                Você recebe um plano prático, de alto impacto, com ações diretas para reverter desafios, fortalecer seu
                time comercial e gerar mais lucro nos próximos 30 dias.
              </p>
            </div>
          </div>
          ...
          <div className="mt-16 text-center">
            <div className="inline-block bg-black/80 backdrop-blur-sm p-6 rounded-xl shadow-xl border border-amber-500/30">
              <p className="text-white text-lg mb-6 max-w-2xl mx-auto whitespace-pre-line">
                Ao final da Sessão Estratégica, você terá clareza absoluta sobre: Onde está deixando dinheiro na mesa e
                como recuperar cada centavo. Os ajustes imediatos que vão gerar um crescimento de até 50% no seu lucro
                em até 30 dias. Um plano claro e estruturado para escalar sua operação comercial de forma sólida e
                consistente nos próximos 90 dias.
              </p>
          ...
          <div className="md:flex items-center gap-12">
            ...
            <div className="md:w-3/5">
              ...
              <p className="text-lg mb-6 text-gray-300">
                Eu sou o John, empresário desde 2012 e, desde 2017, me especializei em três pilares que transformaram
                meus resultados e os de mais de mil empresas mentoradas: Venda Direta, Pessoas e Performance e
                Estrutura.
              </p>

              <p className="text-lg mb-6 text-gray-300">
                Com mais de R$ 1 milhão investidos em estratégias, anúncios e validações, criei o Método IM – Impacto
                Milionário, que já gerou mais de 8 dígitos em vendas.
              </p>

              <p className="text-lg mb-8 text-gray-300">
                O Método IM foi criado para empresas B2B que querem escalar com estratégia e consistência, focando em
                três fundamentos:
                <br />• <span className="text-amber-400 font-semibold">Atrair clientes todos os dias</span>
                <br />• <span className="text-amber-400 font-semibold">Aumentar o ticket médio</span>
                <br />•{" "}
                <span className="text-amber-400 font-semibold">
                  Estruturar uma operação lucrativa, com ou sem o dono presente
                </span>
                <br />
                <br />
                Hoje ensino empresários a crescerem de forma previsível, com um plano prático que gera resultados reais
                em até 30 dias.
              </p>
              ...
              <div className="flex flex-wrap gap-4 mb-8">
                {/* Instagram */}
                <a
                  href="https://www.instagram.com/johnimpactomilionario?igsh=MWhyN284OGw1dzh3NQ%3D%3D&utm_source=qr"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 bg-gradient-to-r from-amber-500/10 to-amber-600/10 hover:from-amber-500/20 hover:to-amber-600/20 border border-amber-500/30 rounded-lg px-4 py-2 transition-all duration-300"
                >
                  <svg
                ...
                {/* TikTok */}
                <a
                  href="https://www.tiktok.com/@john.impacto.mili?_t=ZM-8wFSby6DgFr&_r=1"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 bg-gradient-to-r from-amber-500/10 to-amber-600/10 hover:from-amber-500/20 hover:to-amber-600/20 border border-amber-500/30 rounded-lg px-4 py-2 transition-all duration-300"
                >
                ...
                {/* Threads */}
                <a
                  href="https://www.threads.com/@johnimpactomilionario?igshid=NTc4MTIwNjQ2YQ=="
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 bg-gradient-to-r from-amber-500/10 to-amber-600/10 hover:from-amber-500/20 hover:to-amber-600/20 border border-amber-500/30 rounded-lg px-4 py-2 transition-all duration-300"
                >
                ...
                {/* Twitter */}
                <a
                  href="https://x.com/johnimpactomili?s=21"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 bg-gradient-to-r from-amber-500/10 to-amber-600/10 hover:from-amber-500/20 hover:to-amber-600/20 border border-amber-500/30 rounded-lg px-4 py-2 transition-all duration-300"
                >
                  ...
                  >
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      d="M23 3a10.9 10.9 0 0 1-3.14 1.53A4.48 4.48 0 0 0 22.4.36a9.01 9.01 0 0 1-2.85 1.09A4.48 4.48 0 0 0 16.62 0c-2.62 0-4.74 2.16-4.74 4.81 0 .38.04.75.13 1.1A12.75 12.75 0 0 1 3 1.14a4.74 4.74 0 0 0-.64 2.42c0 1.68.82 3.16 2.06 4.03A4.35 4.35 0 0 1 1.5 6.15v.06a4.8 4.8 0 0 0 3.78 4.72c-.36.1-.74.15-1.13.15-.28 0-.54-.03-.8-.08a4.8 4.8 0 0 0 4.5 3.37A9.03 9.03 0 0 1 1 19.54 12.77 12.77 0 0 0 8.29 21c7.55 0 11.68-6.44 11.68-12.02 0-.18-.01-.37-.02-.55A8.66 8.66 0 0 0 23 3z"
                    />
                  </svg>
                  <span>Twitter</span>
                </a>
                ...
                {/* YouTube */}
                <a
                  href="https://youtube.com/@johnimpactomilionario?si=o1gmVsmffTT6TUsc"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 bg-gradient-to-r from-amber-500/10 to-amber-600/10 hover:from-amber-500/20 hover:to-amber-600/20 border border-amber-500/30 rounded-lg px-4 py-2 transition-all duration-300"
                >
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-b from-zinc-900 to-black p-8 rounded-xl shadow-xl border border-zinc-800">
              ...
              <p className="text-lg mb-6">
                ...
                dentro de operações reais. Nada aqui é teoria: o método já foi aplicado em negócios que saíram do zero
                ou da estagnação e passaram a gerar lucro previsível, vendas diárias e crescimento escalável.
              </p>

              <p className="text-lg mb-6">
                É execução de verdade,{" "}
                <span className="text-amber-500 font-bold">com base no que funciona e no que já, </span>
                transformou empresas desorganizadas e travadas em operações lucrativas, com clareza, processo e
                resultados consistentes, atingindo faturamentos mais altos com controle, margem e escala.
              </p>
          ...
          <div className="md:flex items-center gap-12">
                  ...
                  <div className="absolute top-0 right-0 left-0 bottom-0 bg-black rounded-lg shadow-2xl overflow-hidden">
                    ...
                    <div className="absolute top-1/3 left-0 right-0 bottom-0 flex flex-col items-center justify-center p-6 text-center">
                      ...
                      <p className="text-gray-300 mb-2">
                        O guia completo para vender todos os dias, liderar com clareza e escalar com estrutura, lucro e
                        previsibilidade.
                      </p>
            ...
            <div className="md:w-3/5">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                O guia completo para <span className="text-amber-500">vender todos os dias,</span> liderar com clareza e
                escalar com <span className="text-amber-500">estrutura, lucro e previsibilidade.</span>
              </h2>

              <p className="text-lg mb-6 text-gray-300">
                O guia completo com todas as estratégias, scripts e ferramentas que utilizamos para transformar times
                comerciais e gerar resultados extraordinários.
              </p>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-8 leading-snug">
              ...
              <br />e <span className="text-amber-500">alcançar resultados extraordinários?</span>
            </h2>

            <p className="text-xl text-gray-300 mb-12 max-w-1xl mx-auto leading-relaxed">
              Agora é o momento de aplicar as estratégias que vão alavancar o lucro do seu negócio,
              <br />
              gerar crescimento previsível e construir uma empresa sólida e lucrativa.
              <br />
              Se você está pronto para resultados reais e um futuro de sucesso,{" "}
              <strong>estou aqui para te ajudar a conquistar isso!</strong>
              <br />
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <a
          href="https://wa.me/554731703648?text=Olá!%20Vi%20seu%20site%20e%20gostaria%20de%20agendar%20uma%20sessão%20estratégica%20para%20transformar%20meu%20time%20comercial."
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center w-14 h-14 md:w-16 md:h-16 bg-[#25D366] rounded-full shadow-lg hover:bg-[#20c25e] transition-all duration-300"
        >
